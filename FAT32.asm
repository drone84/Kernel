...
Sector_loaded_in_ram = $1902F ; updated by any function readding Sector from FDD like : IFAT32_READ_BOOT_SECTOR / IFAT32_GET_ROOT_DIR_POS
...
FAT32_Sector_index = $19053 ; store the sector index of the first fat sector
FAT32_next_entry = $19055  ; store the 12 bit fat entry
FAT32_Sector_loaded_in_ram = $19057 ; store the actual fat sector loades in ram
...
IFAT32_READ_BOOT_SECTOR
                  ...
                  LDY #<>Volume_Label
                  LDA #11-1
                  MVN `Volume_Label , `FAT32_ADDRESS_BUFFER_512
                  ...
                  LDA #8-1
                  MVN `File_System_Type, `FAT32_ADDRESS_BUFFER_512
...
FDD_SECTOR_ALREADDY_LOADDES_IN_RAM
                  ...
                  TAY
                  LDA #31
                  MVN `Root_entry_value, `FAT32_ADDRESS_BUFFER_512
                  PLA

                  BRA RETURN_IFAT32_IFAT32_GET_ROOT_ENTRY
FAT32_ERROR_NB_ROOT_ENTRY_INDEX
                  LDA #-1
RETURN_IFAT32_IFAT32_GET_ROOT_ENTRY
                  RTL
;-------------------------------------------------------------------------------
;
;
...
FAT32_COMPUT_OFSET_IN_CLUSTER
                  ...
                  BRA RETURN_IFAT32_GET_FAT_ENTRY
...
FAT32_ODD_FAT_ENTRY
                  ...
                  ASL
                  ASL
                  STA FAT32_next_entry ; save the low fat entry
                  PLA ; get the low paart
                  CLC
                  ADC FAT32_next_entry ; add the low part to the hi part
                  STA FAT32_next_entry
                  PLA ; get the initial fat entry, FAT32_next_entry contain the next fat entry and sector to read
RETURN_IFAT32_GET_FAT_ENTRY
                  RTL
